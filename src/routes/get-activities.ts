...
export async function getActivity(app:FastifyInstance) {
    ...
    app.withTypeProvider<ZodTypeProvider>().get('/trips/:tripId/activities', {
        ...
        const differenceInDaysBetweenTripStartAndEnd = dayjs(trip.ends_at).diff(trip.starts_at, 'days') // data de termino e inicio da viagem
        ...
        }) // ordena os dias das viagens e retorna as atividades de cada um deles
